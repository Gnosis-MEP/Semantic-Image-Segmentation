...
TORCH_HOME = config('TORCH_HOME', default='')
MODEL_NAME = config('MODEL_NAME', default='deeplabv3_resnet50')
SETUP_MODEL_ON_START = config('SETUP_MODEL_ON_START', default=True, cast=bool)
