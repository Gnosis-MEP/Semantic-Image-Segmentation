...
class TestSemanticImageSegmentation(MockedEventDrivenServiceStreamTestCase):
    ...
    SERVICE_CLS = SemanticImageSegmentation
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-SemanticImageSegmentation': MOCKED_CG_STREAM_DICT,
    }

    @patch('semantic_image_segmentation.service.SemanticImageSegmentation.process_event_type')
